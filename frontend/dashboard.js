...
// //     try {
// //         const response = await fetch('https://api.ecg-iit-ju-shaon.xyz/api/doctor-stats');
...
// //         const patientRes = await fetch('https://api.ecg-iit-ju-shaon.xyz/api/doctor-patient-list');
...
// //     try {
// //         const res = await fetch('https://api.ecg-iit-ju-shaon.xyz/api/predict', {
// //             method: 'POST',
...
// //     try {
// //         const response = await fetch('https://api.ecg-iit-ju-shaon.xyz/api/send-feedback', {
// //             method: 'POST',
// //             headers: { 'Content-Type': 'application/json' },
// //             body: JSON.stringify({
...
// //     try {
// //         const response = await fetch('https://api.ecg-iit-ju-shaon.xyz/api/chatbot', {
// //             method: 'POST',
// //             headers: { 'Content-Type': 'application/json' },
...
// //         const res = await fetch('https://api.ecg-iit-ju-shaon.xyz/api/ecg-predict', {
// //             method: 'POST',
// //             body: formData,
// //         });
...
// //     try {
// //         const res = await fetch('https://api.ecg-iit-ju-shaon.xyz/api/save-ecg-report', {
// //             method: 'POST',
// //             headers: { 'Content-Type': 'application/json' },
...
// ─── ECG state ────────────────────────────────────────────────
let ecgSelectedFile = null;
let ecgRawData = null;
let ecgAnalysisResult = null;
let ecgWaveformChart = null;
let ecgProbChart = null;
let ecgConfChart = null;
let ecgStartTimeValue = null;
...
// ─────────────────────────────────────────────────────────────
// AI PREDICTOR HANDLER (BULLETPROOFED & SYNCHRONIZED)
// ─────────────────────────────────────────────────────────────
async function handlePredict(e) {
    e.preventDefault();
    const userId = localStorage.getItem('userId');
    ...
    try {
        ...
        if (res.ok) {
            if (resultBox) {
                ...
                const predDrugs = document.getElementById('predDrugs');
                const predFoods = document.getElementById('predFoods');
                const predRoutine = document.getElementById('predRoutine');

                if (predDisease) predDisease.innerText = result.prediction || '—';
                if (predScore) predScore.innerText = result.score !== undefined ? result.score : '—';
                if (predDrugs) predDrugs.innerText = result.drugs || '—';
                if (predFoods) predFoods.innerText = result.foods || '—';
                if (predRoutine) predRoutine.innerText = result.routine || '—';
